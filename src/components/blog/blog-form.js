...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://dennisselmeczy.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post"
        };
    ...
    componentDidMount () {
        if (this.props.editMode) {
            ...
            this.setState({
                ...
                content: content,
                apiUrl: `https://dennisselmeczy.devcamp.space/portfolio/portfolio_blogs/${id}`,
                apiAction: "patch"
            });
        }
    }
        ...
        return (
            <form className="blog-form-wrapper" onSubmit={this.handleSubmit}>
                ...
                <div className="image-uploaders">
                    ...
                    <div className="portfolio-manager-image-wrappper">
